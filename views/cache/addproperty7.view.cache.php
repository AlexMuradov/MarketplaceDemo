            ...
            <div class="container">
                <div class="main__content">
                            ...
                            <form action="" method="POST" onsubmit="return validate()">
                                <div class="days__plan">
                                    <div class="field field-payment">
                                        ...
                                        <input type="hidden" name="RequestWindow" class="BeforeArrive" id="input-id">
                                        <div class="icon">
                                ...
                                <div class="days__plan days__plan-two days__plan-two-mb">
                                    ...
                                    <div class="days__plan-items">
                                        <div class="field field-payment">
                                            ...
                                            <input type="hidden" name="CheckInTime" class="TimeFromArrive" id="input-id">                                          
                                            <div class="icon">
                                                <svg class="arrow arrow-down">
                                                    <use xlink:href="/static/img/sprite/sprite.svg#arrow-down"></use>
                                                </svg>
                                        ...
                                        <div class="field field-payment">
                                            ...
                                            <input type="hidden" name="CheckOutTime" class="TimeToArrive" id="input-id">
                                            <div class="icon">
                                                <svg class="arrow arrow-down">
                                                    <use xlink:href="/static/img/sprite/sprite.svg#arrow-down"></use>
                                                </svg>
                                ...
                                <div class="days__plan days__plan-three">
                                    <div class="field field-payment" name="test">
                                        ...
                                        <input type="hidden" name="AdvanceWindow" class="TimeInAdvance" id="input-id">
                                        <div class="icon">
                                            <svg class="arrow arrow-down">
                                                <use xlink:href="/static/img/sprite/sprite.svg#arrow-down"></use>
                                            </svg>
                                        ...
                                        <ul class="dropdown__noactive">
                                            <li class="dropdown-item">
                                                ...
                                                <div class="count ">
                                                    ...
                                                    <input type="text" name="MinNightsStay" class="input-count count__adults" value="1"
                                                        readonly="">
                                            ...
                                            <li class="dropdown-item">
                                                ...
                                                <div class="count ">
                                                    <button type="button" class="count-btn count-minus"></button>
                                                    <input type="text" name="MaxNightsStay" class="input-count count__adults" value="1"
                                                        readonly="">
                                                    <button type="button" class="count-btn count-plus"></button>
                                                </div>
                                            </li>
                                    ...
                                    <div class="long__stay">
                                        ...
                                        <div class="payment__radio">
                                            <label class="label-checkbox label-radio">
                                                <input type="radio" name="InstantBooking" value="1" id="instant" class="checkbox">
                                            ...
                                            <label class="label-checkbox label-radio">
                                                <input type="radio" name="InstantBooking" value="0" id="manual" class="checkbox">
                                                <span class="check check-radio"></span>
                                                <span class="check-text check-radio-text res_ManualApprove"></span></span>
                                            </label>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <h6 class="res_BlockCalendarTitle"></h6>
                                    ...
                                    <button type="button" class="disable">Заблокировать</button>
                                    <button type="button" class="enable">Разблокировать</button>
                                    <button type="button" class="Save" id="SaveCalendar">Save</button>
                                </div>
                    ...
                    <div class="right__content">
                        <div class="protest">
                            <img src="/static/img/protests.svg" alt="protest">
