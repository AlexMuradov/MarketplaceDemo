     ...
     <?php include(HOME . XX . "views/imports/header.html"); ?>
       ...
       <div class="container_v2">
         <main class="page_content"> 
            <div class="left_page_content mob-100">
              <h1 class="title_v2 res_SimpleSteps" style="display: block;"></h1>
              <p class="text_descr res_5Minutes"></p>
              <div class="btn_group">
                <a class="btn_back btn_xl res_GoBack" href="#" onclick="window.history.back()"></a>
                <a class="btn_red btn_xl res_ReadAndAgree" href="/<?php echo $lng; ?>/property.add"></a>
              </div>
            </div>
            <div class="right_page_content mob-none">
              <img src="/static/v2/img/terms_img.svg" alt="">
            </div>
          </main> 
        </div>
