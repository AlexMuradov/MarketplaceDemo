       ...
       <div class="container_v2">
         <main class="page_content"> 
            <div class="left_page_content">
              <h1 class="title_v2 res_SuccessAdd" style="display: block;"></h1>
              <p class="text_descr res_EmailSent"></p>
              <div class="btn_group">
                <a class="btn_back btn_xl res_Close" href="/"></a>
                <a class="btn_red btn_xl res_GoHostCabinet" href="/<?php echo $lng; ?>/cabinet.listings"></a>
              </div>
            </div>
            <div class="right_page_content">
              <img src="/static/v2/img/complete_img.svg" alt="">
            </div>
          </main> 
        </div>
