                    ...
                    $.ajax({
                        ...
                        success: function (json) {
                            for (var i = 0; i < json.length; i++) {
                                ...
                                var htmll = "<div><img style='display:inline; vertical-align:middle' src='/static/uploads/listings/m_thumbs/" + filename + "'><span> <a href='#' onclick='delphoto(" + filenr + ", <?php echo $ListingID; ?>);'>Delete</a> - <a href='#' onclick='makemainp(" + filenr + ", <?php echo $ListingID; ?>)'>MakeMain</a> " + ftype + "</span></div><br/>";
