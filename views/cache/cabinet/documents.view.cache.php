                                        ...
                                        <div class="dropdown-menu dropdown-menu-md dropdown-menu-right dropdown-menu-s1">
                                            <div class="dropdown-inner user-card-wrap bg-lighter d-none d-md-block">
                                                <div class="user-card">
                                                    ...
                                                    <div class="user-info">
                                                        <span class="lead-text" name="fullName">Abu Bin Ishtiyak</span>
                                                        <span class="sub-text" name="email">info@softnio.com</span>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="card card-bordered">
                                        <div class="nk-kycfm">
                                            <div class="nk-kycfm-head">
                                                <div class="nk-kycfm-title" id="docInfoTitle">
                                                    <h5 class="title" >Document Upload</h5>
                                                    <p class="sub-title" id="titleDescription">To verify your identity, please upload any of your document.</p>
                                                </div>
                                            </div><!-- .nk-kycfm-head -->
                                            <div class="nk-kycfm-content">
                                                <div class="nk-kycfm-note" >
                                                    ...
                                                    <p id="docInfoDesc">In order to complete, please upload any of the following personal document.</p>
                                                </div>
