                                ...
                                <div class="nk-block nk-block-xl">
                                    <div class="nk-block-head">
                                        <div class="nk-block-head-content">
                                            <h4 class="nk-block-title"><span class="res_">Пользователи</span></h4>
                                    ...
                                    <div class="card card-preview">
                                        <div class="card-inner">
                                            <table class="table datatable-init nk-tb-list nk-tb-ulist" data-auto-responsive="true">
                                                <thead>
                                                    <tr class="nk-tb-item nk-tb-head">
                                                        <th class="nk-tb-col tb-col-xl"><span class="sub-text res_">DateCreated</span></th>
                                                        <th class="nk-tb-col tb-col-xl"><span class="sub-text res_ID"></span></th>
                                                        <th class="nk-tb-col tb-col-xl"><span class="sub-text res_">Email</span></th>
                                                        <th class="nk-tb-col tb-col-xl"><span class="sub-text res_">DateModified</span></th>
                                                        <th class="nk-tb-col tb-col-xl"><span class="sub-text res_">DisplayName</span></th>
                                                        <th class="nk-tb-col tb-col-xl"><span class="sub-text res_">Name</span></th>
                                                        <th class="nk-tb-col tb-col-xl"><span class="sub-text res_">Surname</span></th>
                                                        <th class="nk-tb-col tb-col-xl"><span class="sub-text res_">Address</span></th>
                                                        <th class="nk-tb-col tb-col-xl"><span class="sub-text res_">Phone</span></th>
                                                        <th class="nk-tb-col tb-col-xl"><span class="sub-text res_">VerifiedEmail</span></th>
                                                        </th>
                                                    </tr>
                                                </thead>
                                                <tbody id="UsersList">
