...
<body class="nk-body bg-white has-sidebar ">
                                ...
                                <div class="nk-block nk-block-xl">
                                    <div class="nk-block-head">
                                        <div class="nk-block-head-content">
                                            <h4 class="nk-block-title"><span class="res_Transactions"></span></h4>
                                            ...
                                            <table class="datatable-init nk-tb-list nk-tb-ulist" data-auto-responsive="false">
                                                <thead>
                                                    <tr class="nk-tb-item nk-tb-head">
                                                        ...
                                                        <th class="nk-tb-col"><span class="sub-text res_From"></span></th>
                                                        <th class="nk-tb-col tb-col-sm"><span class="sub-text res_To"></span></th>
                                                        <th class="nk-tb-col tb-col-sm"><span class="sub-text res_Amount"></span></th>
                                                        <th class="nk-tb-col tb-col-sm"><span class="sub-text res_Date"></span></th>
                                                        <th class="nk-tb-col tb-col-sm"><span class="sub-text res_Status"></span></th>
    ...
    <!-- app-root @e -->
    <!-- JavaScript -->
    <script data-cfasync="false" src="/cdn-cgi/scripts/5c5dd728/cloudflare-static/email-decode.min.js"></script><script src="./assets/js/bundle.js?ver=2.0.0"></script>
