                            ...
                            <div class="nk-block nk-block-lg">
                                <div class="nk-block nk-block-lg">
                                    <div class="nk-block-head-content">
                                        <div class="row">
                                            <div class="col-lg-6 col-md-6 col-sm-12 reserv-title">
                                                <h4 class="title nk-block-title"><span class="bookHeader">The booking in <span class="bookCity"></span> <span class="bookStatus">на рассмотрении </span><em class="icon ni ni-question text-warning"></em></span></h4>
                                            </div>
                                            <div class="col-lg-6 col-md-6 col-sm-12 d-flex justify-content-end">
                                                ...
                                                <h5 class="text-right">
                                                    <button onclick="window.print()" class="btn btn-primary"><em class="icon ni ni-printer"></em><span>Print</span></button>    
                                                </h5>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="nk-block nk-block-lg">
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        ...
                                        <div class="nk-block nk-block-lg">
                                            <h6 class="title bookDescription"></h6>
                                            <ul class="list-plain">
                                                <li><span class="bookAddress"></span></li>
                                            ...
                                            <table class="table table-striped">
                                                <tbody>
                                                    <tr>
                                                        <td>Phone</td>
                                                        <td class="bookPhone text-right"></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Email</td>
                                                        <td class="bookEmail text-right"></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Your reservation</td>
                                                        <td class="bookNightsCount text-right">1 ноч.</td>
                                                    </tr>
                                                    <tr>
                                                        <td>Check-in</td>
                                                        <td class="bookDateFrom text-right"></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Check-out</td>
                                                        <td class="bookDateTo text-right"></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Total Price</td>
                                                        <td class="bookPrice text-right">$123</td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="card">
                                            <div class="d-flex justify-content-center">
                                                <img class="d-block w-100 rounded listingImg" src="" alt="img">
                                            </div>
                                        </div><!-- .card-preview -->
                                    </div>
                                </div>
