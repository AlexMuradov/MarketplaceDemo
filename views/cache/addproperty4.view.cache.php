...
<body>
    ...
    <div id="wrapper">
        ...
        <header class="header header-main">
            ...
            <div class="progress progress__four progress-striped">
        ...
        <div id="wrapper-content">
            <div class="container">
                <div class="title apartaments__title">
                    <h2 class="res_AmenitiesTitle"></h2>
                </div>
                <form class="container__box" action="" method="POST">
                <input type="hidden" name="step4_submit" value="1">
                    <div class="checkbox__add" id="AmenitiesList"></div>
