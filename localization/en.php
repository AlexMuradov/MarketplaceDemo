...
Class Language {
    ...
    static $LngTitles = [
        "home" => "Instant property — Rentxx",
        "property/search" => "Search — Rentxx",
        "property/display" => " — Rentxx",
        "property/add" => "Add your property — Rentxx",
        "auth/verify" => "Security code verification — Rentxx",
        "auth/signin" => "Sign in — Rentxx",
        "auth/registration" => "New account — Rentxx",
    ...
    static $LngHomepageHeader = [
        ['Instant booking.', 'Quick confirmation.', 'Convenient booking.'],
        ['Verified apartments.', 'No intermediaries.', '24/7 Support.'],
        ['Payment by card.', 'Without % additional fees.', 'No hidden commissions.', 'VISA/MasterCard.']
    ];

    static $LngHome = array(
        "LoginSuccess" => "You have successfully logged in.",
        "LoginFail" => "Login failed, invalid username or password.", 
        "InstantBooking" => "Instant apartment booking",
        "Close" => "Close",
        "LoadNow" => "Load now",
        "OnlinePayment" => "Online payment",
        "CatalogTotal" => "3842 places to stay in catalog", 
        "City" => "City",
        "Arrival" => "Check in",
        "Departure" => "Check out",
        ...
        "Persons" => "pers.",
        "Adults" => "Adults",
        "v13yo" => "from 13 years old",
        "Children" => "Kids",
        "v12yo" => "up to 12 years old",
        "Baby" => "Babies",
        "v3yo" => "up to 3 years old",
        "HeadAddApt" => "add property",
        "HeadEnter" => "Log in",
        "HeadProfile" => "my profile <span class=\"n_round\"></span>",
        "Search" => "SEARCH",
        "RecentlyViewed" => "Recently viewed",
        "InstantBookingButton" => "INSTANT BOOKING",
        "TopBaku" => "Best offers in Baku",
        "AllProperty" => "ALL PROPERTY",
        "Registration" => "Registration",
        "HowtoConnect" => "How to connect to the service",
        "v2min" => "(2 min)",
        "RegHintText" => "Reg text Reg text Reg",
        "AddPropHint" => "add appt text",
        "AddAptTitle" => "host your apartment",
        "v6min" => "(6 min)",
        "GetMoneyHintTitle" => "receiving money",
        "Instant" => "(instant)",
        "CompanySlogan" => "Instant apartment booking <br> without commissions using online payment",
        "GetMoneyHint" => "getting money text",
        "Getmails" => "Get notififations by mail",
        "OnlyFreeProperties" => "Only free properties",
        "Where" => "Where?",
        "Nearby" => "Find accommodation nearby"
    );
    ...
    static $LngRegistration = array(
        "Title" => "Registration",
        "LoginInvalidEmail" => "This is a new variable",
        "LoginWrongDetails" => "Invalid email or password",
        "LoginShortPassword" => "This is error 2",
        "RegistrationSuccess" => "You have successfully registered.",
        "RegistrationFail" => "Registration error.",
        "RegistrationEmailExists" => "Invalid e-mail address.",
        "RegistrationWrongNumber" => "Invalid number format",
        "RegistrationShortNumber" => "Number is too short",
        "RegistrationNumberExists" => "This number have already registered, log in or <a href=\"#\" class=\"error-link\">recover your password</a>",
        "RegistrationInvalidEmail" => "Invalid e-mail address.",
        "RegistrationShortPassword" => "Minimum password length is 6 characters.",
        "RegistrationWrongCode" => "Invalid authentication code.",
        "Country" => "Country"
    );
    ...
    static $LngAddProperty = array(
        ...
        "PropertyTitle" => "Enter the property title",
    ...
    static $LngDisplay = array(
        ...
        "Share" => "Share",
        "Send" => "Send",
        "SleepPlaces" => "Sleeping places",
        "Bedroom" => "Bedroom",
        "Room" => "Room",
        "ToRemember" => "Things to Remember",
        "Arrive" => "Arrive",
        "Departure" => "Departure",
        "FreeCancel" => "Free cancellation by ",
        "Amenities" => "Amenities",
        "Rules" => "Rules",
        "ShowMore" => "show more ",
        "Hide" => "hide",
